...
cc.Class({
    ...
    onLoad() {
        ...
        this._radius = this.ring.width / 2 - this.dot.width/2;
    ...
    _touchMoveEvent(event) {
        ...
        let joystickAngle = Math.atan2(this.dot.y-this._stickPos.y, this.dot.x-this._stickPos.x);  //得到弧度
        joystickAngle = joystickAngle * 180 / Math.PI;     //操纵杆角度
        ModelMgr._touchMoveEvent(joystickAngle);
    },
